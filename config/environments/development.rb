...
Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    address: "smtp.maileraction.com",  # Asegúrate de que sea el servidor correcto
    port: 587,  # Usualmente 465 o 587 para SMTP
    domain: "maileraction.com",
    user_name: "support@maileraction.com",  # Tu dirección de correo
    password: "Aldus1024@",  # Tu contraseña
    authentication: "plain",
    enable_starttls_auto: true
  }

  # Esto asegura que los correos se envíen en el entorno correcto
